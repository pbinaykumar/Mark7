...
class SearchView(APIView):
    ...
    def post(self,request,format = None):
        ...
        for query in queryset:
            num_day = (datetime.now(timezone.utc)-query.list_date).days

            if days_passed != 0:
                if num_day > days_passed:
                    slug=query.slug
        ...
        queryset = queryset.filter(descriptions__icontains=keywords)
